...
return [
	...
	*/
	...
	"alpha_dash"           => "يجب أن يحتوي الحقل :attribute على حروف، أرقام ومطّات فقط.",
	...
	"without_char"   	   => "يجب الا يحتوى حقل :attribute على رموز خاصة",
	/*
	|--------------------------------------------------------------------------
	...
	*/
	...
	'attributes'           => [
		...
		'photo'           => 'الصورة',
		'specialable_id'  => '',
		'is_soon'         => 'يظهر في ترقبوا',
		'is_reader'       => 'قارئ',
		'is_preacher'     => 'داعية',
		'is_singer'       => 'منشد',
		'ar'              => [ 'title' => 'عنوان', 'name' => 'الاسم', 'type' => 'النوع', 'content' => 'المحتوى' ],
		'en'              => [ 'title' => 'عنوان', 'name' => 'الاسم', 'type' => 'النوع', 'content' => 'المحتوى' ],
		'fa'              => [ 'title' => 'عنوان', 'name' => 'الاسم', 'type' => 'النوع', 'content' => 'المحتوى' ],
		'is_active'       => 'مفعل',
	],
